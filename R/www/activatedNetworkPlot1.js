...
var repelForce = d3.forceManyBody().strength(20).distanceMax(500).distanceMin(200);
...
Shiny.addCustomMessageHandler("refreshActivatedNetwork1", refresh);
...
Shiny.addCustomMessageHandler("downloadActivatedNetwork1", downloadPlot);
