...
var legendText = g.selectAll("mylabels")
  ...
  // group each type of nodes
    ...
    var CellNode=nodes.filter(function(d){return d.parent=="cell";}).attr("class","cell");
...
Shiny.addCustomMessageHandler("refreshUpRegReceptor", refresh);
